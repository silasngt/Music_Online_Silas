...
export default function ButtonHeart(props:any){
    ...
    return(
        ...
        className= {
            "w-[34px] h-[34px] rounded-full border border-white inline-flex items-center justify-center text-[15px] text-white ml-[10px] " + (isActive ? "border-primary bg-primary" :"border-white")
        }
        >
            <FaHeart/>
        </button>
